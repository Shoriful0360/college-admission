      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {papers?.map((paper, idx) => (
          ...
          >
            ...
            <p className="text-gray-600 text-sm line-clamp-3 flex-1">{paper.description}</p>
            ...
            <Link
             to={`/research_papers/${paper._id}`}
              ...
              className="inline-block mt-4 w-fit px-4 py-2 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-500 transition-colors"
            >
              Read Paper
            </Link>
          </div>
